...
sleep $s; /opt/postgres/master/bin/pgbench -c4 -j4 -P1 -f ../a.sql -T${w} -U postgres pgbench 			&>c4j4FT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c4 -j4 -P1 -f ../a.sql -S -T${w} -U postgres pgbench 		&>c4j4FST100.txt
...
sleep $s; /opt/postgres/master/bin/pgbench -c8 -j4 -P1 -T${w} -U postgres pgbench 				&>c8j4T100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c8 -j4 -P1 -S -T${w} -U postgres pgbench 				&>c8j4ST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c8 -j4 -P1 -M prepared -T${w} -U postgres pgbench 			&>c8j4MT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c8 -j4 -P1 -M prepared -S -T${w} -U postgres pgbench 		&>c8j4MST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c8 -j4 -P1 -f ../a.sql -T${w} -U postgres pgbench 			&>c8j4FT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c8 -j4 -P1 -f ../a.sql -S -T${w} -U postgres pgbench 		&>c8j4FST100.txt
...
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -T${w} -U postgres pgbench 				&>c64j4T100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -S -T${w} -U postgres pgbench 				&>c64j4ST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -M prepared -T${w} -U postgres pgbench 			&>c64j4MT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -M prepared -S -T${w} -U postgres pgbench 		&>c64j4MST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -f ../a.sql -T${w} -U postgres pgbench 			&>c64j4FT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -f ../a.sql -S -T${w} -U postgres pgbench 		&>c64j4FST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -M prepared -f ../a.sql -T${w} -U postgres pgbench 	&>c64j4MFT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -M prepared -f ../a.sql -S -T${w} -U postgres pgbench 	&>c64j4MFST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -C -T${w} -U postgres pgbench 				&>c64j4CT100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -C -S -T${w} -U postgres pgbench 			&>c64j4CST100.txt
sleep $s; /opt/postgres/master/bin/pgbench -c64 -j4 -P1 -C -M prepared -T${w} -U postgres pgbench 		&>c64j4CMT100.txt
