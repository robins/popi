...
sleep $s; ${bindir}/bin/pgbench -c4 -j4 -P1 -f ${q} -T${w} -U postgres pgbench 			&>c4j4FT100.txt
sleep $s; ${bindir}/bin/pgbench -c4 -j4 -P1 -f ${q} -S -T${w} -U postgres pgbench 		&>c4j4FST100.txt
sleep $s; ${bindir}/bin/pgbench -c4 -j4 -P1 -M prepared -f ${q} -T${w} -U postgres pgbench 	&>c4j4MFT100.txt
sleep $s; ${bindir}/bin/pgbench -c4 -j4 -P1 -M prepared -f ${q} -S -T${w} -U postgres pgbench 	&>c4j4MFST100.txt
...
sleep $s; ${bindir}/bin/pgbench -c8 -j4 -P1 -f ${q} -T${w} -U postgres pgbench 			&>c8j4FT100.txt
sleep $s; ${bindir}/bin/pgbench -c8 -j4 -P1 -f ${q} -S -T${w} -U postgres pgbench 		&>c8j4FST100.txt
sleep $s; ${bindir}/bin/pgbench -c8 -j4 -P1 -M prepared -f ${q} -T${w} -U postgres pgbench 	&>c8j4MFT100.txt
sleep $s; ${bindir}/bin/pgbench -c8 -j4 -P1 -M prepared -f ${q} -S -T${w} -U postgres pgbench 	&>c8j4MFST100.txt
...
sleep $s; ${bindir}/bin/pgbench -c64 -j4 -P1 -f ${q} -T${w} -U postgres pgbench 			&>c64j4FT100.txt
sleep $s; ${bindir}/bin/pgbench -c64 -j4 -P1 -f ${q} -S -T${w} -U postgres pgbench 		&>c64j4FST100.txt
sleep $s; ${bindir}/bin/pgbench -c64 -j4 -P1 -M prepared -f ${q} -T${w} -U postgres pgbench 	&>c64j4MFT100.txt
sleep $s; ${bindir}/bin/pgbench -c64 -j4 -P1 -M prepared -f ${q} -S -T${w} -U postgres pgbench 	&>c64j4MFST100.txt
